...
my ($acc6,$acc7)=($bp,$bi);	# used in __GFp_nistz256_sqr_mont
...
___
########################################################################
# Convert GFp_nistz256_table.c to layout expected by GFp_nistz_gather_w7
#
$0 =~ m/(.*[\/\\])[^\/\\]+$/; $dir=$1;
open TABLE,"<GFp_nistz256_table.c"		or
open TABLE,"<${dir}../ecp_nistz256_table.inl"	or
die "failed to open ecp_nistz256_table.inl:",$!;
...
# See GFp_nistz256_table.c for explanation for why it's 64*16*37.
# 64*16*37-1 is because $#arr returns last valid index or @arr, not
# amount of elements.
die "insane number of elements" if ($#arr != 64*16*37-1);

$code.=<<___;
.type	GFp_nistz256_precomputed,\@object
.globl	GFp_nistz256_precomputed
.align	12
...
$code.=<<___;
.size	GFp_nistz256_precomputed,.-GFp_nistz256_precomputed
...
# void	GFp_nistz256_div_by_2(BN_ULONG x0[4],const BN_ULONG x1[4]);
.globl	GFp_nistz256_div_by_2
.align	4
GFp_nistz256_div_by_2:
	stdu	$sp,-128($sp)
	mflr	r0
	std	r28,96($sp)
	std	r29,104($sp)
	...
	.long	0
.size	GFp_nistz256_div_by_2,.-GFp_nistz256_div_by_2

# void	GFp_nistz256_mul_by_2(BN_ULONG x0[4],const BN_ULONG x1[4]);
.globl	GFp_nistz256_mul_by_2
.align	4
GFp_nistz256_mul_by_2:
	stdu	$sp,-128($sp)
	mflr	r0
	std	r28,96($sp)
	std	r29,104($sp)
	...
	bl	__GFp_nistz256_add	# ret = a+a	// 2*a
	...
	.byte	0,12,4,0,0x80,4,3,0
	.long	0
.size	GFp_nistz256_mul_by_2,.-GFp_nistz256_mul_by_2

# void	GFp_nistz256_mul_by_3(BN_ULONG x0[4],const BN_ULONG x1[4]);
.globl	GFp_nistz256_mul_by_3
.align	4
GFp_nistz256_mul_by_3:
	stdu	$sp,-128($sp)
	mflr	r0
	std	r28,96($sp)
	std	r29,104($sp)
	...
	bl	__GFp_nistz256_add	# ret += a	// 2*a+a=3*a
	...
	.byte	0,12,4,0,0x80,4,2,0
	.long	0
.size	GFp_nistz256_mul_by_3,.-GFp_nistz256_mul_by_3

# void	GFp_nistz256_sub(BN_ULONG x0[4],const BN_ULONG x1[4],
#				        const BN_ULONG x2[4]);
.globl	GFp_nistz256_sub
.align	4
GFp_nistz256_sub:
	stdu	$sp,-128($sp)
	mflr	r0
	...
	.byte	0,12,4,0,0x80,4,3,0
	.long	0
.size	GFp_nistz256_sub,.-GFp_nistz256_sub
...
# note that __GFp_nistz256_mul_mont expects a[0-3] input pre-loaded
# to $a0-$a3 and b[0] - to $bi
.type	__GFp_nistz256_mul_mont,\@function
.align	4
__GFp_nistz256_mul_mont:
...
$code.=<<___;
	...
	.long	0
.size	__GFp_nistz256_mul_mont,.-__GFp_nistz256_mul_mont

# note that __GFp_nistz256_sqr_mont expects a[0-3] input pre-loaded
# to $a0-$a3
.type	__GFp_nistz256_sqr_mont,\@function
.align	4
__GFp_nistz256_sqr_mont:
	################################################################
	#  |  |  |  |  |  |a1*a0|  |
	#  |  |  |  |  |a2*a0|  |  |
	#  |  |a3*a2|a3*a0|  |  |  |
...
$code.=<<___;
	...
	.byte	0,12,0x14,0,0,0,1,0
	.long	0
.size	__GFp_nistz256_sqr_mont,.-__GFp_nistz256_sqr_mont

# Note that __GFp_nistz256_add expects both input vectors pre-loaded to
# $a0-$a3 and $t0-$t3. This is done because it's used in multiple
# contexts, e.g. in multiplication by 2 and 3...
.type	__GFp_nistz256_add,\@function
.align	4
__GFp_nistz256_add:
	...
	.long	0
.size	__GFp_nistz256_add,.-__GFp_nistz256_add

.type	__GFp_nistz256_sub_from,\@function
.align	4
__GFp_nistz256_sub_from:
	ld	$t0,0($bp)
	ld	$t1,8($bp)
	ld	$t2,16($bp)
	ld	$t3,24($bp)
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	__GFp_nistz256_sub_from,.-__GFp_nistz256_sub_from

.type	__GFp_nistz256_sub_morf,\@function
.align	4
__GFp_nistz256_sub_morf:
	ld	$t0,0($bp)
	ld	$t1,8($bp)
	ld	$t2,16($bp)
	ld	$t3,24($bp)
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	__GFp_nistz256_sub_morf,.-__GFp_nistz256_sub_morf

.type	__GFp_nistz256_div_by_2,\@function
.align	4
__GFp_nistz256_div_by_2:
	andi.	$t0,$acc0,1
	...
	.byte	0,12,0x14,0,0,0,1,0
	.long	0
.size	__GFp_nistz256_div_by_2,.-__GFp_nistz256_div_by_2
___
########################################################################
...
.Ldouble_shortcut:
	...
	mr	$t3,$acc3
	 ...
	 mr	$ap_real,$ap
	addi	$rp,$sp,$S
	bl	__GFp_nistz256_add	# p256_mul_by_2(S, in_y);

	addi	$rp,$sp,$Zsqr
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(Zsqr, in_z);
	...
	mr	$a3,$acc3
	addi	$rp,$sp,$M
	bl	__GFp_nistz256_add	# p256_add(M, Zsqr, in_x);
	...
	mr	$acc3,$a3
	 ...
	 ld	$a3,$S+24($sp)
	addi	$rp,$sp,$Zsqr
	bl	__GFp_nistz256_sub_morf	# p256_sub(Zsqr, in_x, Zsqr);

	addi	$rp,$sp,$S
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(S, S);
	...
	addi	$bp,$ap_real,32
	addi	$rp,$sp,$tmp0
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(tmp0, in_z, in_y);
	...
	mr	$t3,$acc3
	 ...
	 ld	$a3,$S+24($sp)
	addi	$rp,$rp_real,64
	bl	__GFp_nistz256_add	# p256_mul_by_2(res_z, tmp0);

	addi	$rp,$sp,$tmp0
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(tmp0, S);
	 ...
	 ld	$a3,$M+24($sp)
	addi	$rp,$rp_real,32
	bl	__GFp_nistz256_div_by_2	# p256_div_by_2(res_y, tmp0);

	addi	$bp,$sp,$Zsqr
	addi	$rp,$sp,$M
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(M, M, Zsqr);
	...
	mr	$t3,$a3
	 ...
	 ld	$a2,$S+16($sp)
	 ld	$a3,$S+24($sp)
	bl	__GFp_nistz256_add	# p256_mul_by_3(M, M);

	addi	$bp,$ap_real,0
	addi	$rp,$sp,$S
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S, S, in_x);
	...
	mr	$t3,$acc3
	 ...
	 ld	$a3,$M+24($sp)
	addi	$rp,$sp,$tmp0
	bl	__GFp_nistz256_add	# p256_mul_by_2(tmp0, S);

	addi	$rp,$rp_real,0
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(res_x, M);

	addi	$bp,$sp,$tmp0
	bl	__GFp_nistz256_sub_from	# p256_sub(res_x, res_x, tmp0);

	addi	$bp,$sp,$S
	addi	$rp,$sp,$S
	bl	__GFp_nistz256_sub_morf	# p256_sub(S, S, res_x);
	...
	mr	$a3,$acc3
	addi	$bp,$sp,$M
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S, S, M);

	addi	$bp,$rp_real,32
	addi	$rp,$rp_real,32
	bl	__GFp_nistz256_sub_from	# p256_sub(res_y, S, res_y);
...
GFp_nistz256_point_add:
	...
	addi	$rp,$sp,$Z2sqr
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(Z2sqr, in2_z);
	...
	addi	$rp,$sp,$Z1sqr
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(Z1sqr, in1_z);
	...
	addi	$bp,$bp_real,64
	addi	$rp,$sp,$S1
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S1, Z2sqr, in2_z);
	...
	addi	$bp,$ap_real,64
	addi	$rp,$sp,$S2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S2, Z1sqr, in1_z);
	...
	addi	$bp,$ap_real,32
	addi	$rp,$sp,$S1
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S1, S1, in1_y);
	...
	addi	$bp,$bp_real,32
	addi	$rp,$sp,$S2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S2, S2, in2_y);
	...
	addi	$bp,$sp,$S1
	 ...
	 ld	$a3,24($ap_real)
	addi	$rp,$sp,$R
	bl	__GFp_nistz256_sub_from	# p256_sub(R, S2, S1);
	...
	addi	$bp,$sp,$Z2sqr
	addi	$rp,$sp,$U1
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(U1, in1_x, Z2sqr);
	...
	addi	$bp,$sp,$Z1sqr
	addi	$rp,$sp,$U2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(U2, in2_x, Z1sqr);
	...
	addi	$bp,$sp,$U1
	 ...
	 ld	$a3,$R+24($sp)
	addi	$rp,$sp,$H
	bl	__GFp_nistz256_sub_from	# p256_sub(H, U2, U1);
...
.Ladd_proceed:
	addi	$rp,$sp,$Rsqr
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(Rsqr, R);
	...
	addi	$bp,$ap_real,64
	addi	$rp,$sp,$res_z
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(res_z, H, in1_z);
	...
	ld	$a3,$H+24($sp)
	addi	$rp,$sp,$Hsqr
	bl	__GFp_nistz256_sqr_mont	# p256_sqr_mont(Hsqr, H);
	...
	addi	$bp,$bp_real,64
	addi	$rp,$sp,$res_z
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(res_z, res_z, in2_z);
	...
	addi	$bp,$sp,$H
	addi	$rp,$sp,$Hcub
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(Hcub, Hsqr, H);
	...
	addi	$bp,$sp,$Hsqr
	addi	$rp,$sp,$U2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(U2, U1, Hsqr);
	...
	mr	$t3,$acc3
	addi	$rp,$sp,$Hsqr
	bl	__GFp_nistz256_add	# p256_mul_by_2(Hsqr, U2);

	addi	$bp,$sp,$Rsqr
	addi	$rp,$sp,$res_x
	bl	__GFp_nistz256_sub_morf	# p256_sub(res_x, Rsqr, Hsqr);

	addi	$bp,$sp,$Hcub
	bl	__GFp_nistz256_sub_from	# p256_sub(res_x, res_x, Hcub);
	...
	addi	$bp,$sp,$U2
	 ...
	 ld	$a3,$S1+24($sp)
	addi	$rp,$sp,$res_y
	bl	__GFp_nistz256_sub_morf	# p256_sub(res_y, U2, res_x);

	addi	$bp,$sp,$Hcub
	addi	$rp,$sp,$S2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S2, S1, Hcub);
	...
	addi	$bp,$sp,$R
	addi	$rp,$sp,$res_y
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(res_y, res_y, R);

	addi	$bp,$sp,$S2
	bl	__GFp_nistz256_sub_from	# p256_sub(res_y, res_y, S2);
...
GFp_nistz256_point_add_affine:
	...
	addi	$bp,$bp_real,0
	addi	$rp,$sp,$U2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(U2, Z1sqr, in2_x);
	...
	addi	$bp,$ap_real,0
	 ...
	 ld	$a3,$Z1sqr+24($sp)
	addi	$rp,$sp,$H
	bl	__GFp_nistz256_sub_from	# p256_sub(H, U2, in1_x);
	...
	addi	$bp,$ap_real,32
	 ...
	 ld	$a3,$H+24($sp)
	addi	$rp,$sp,$R
	bl	__GFp_nistz256_sub_from	# p256_sub(R, S2, in1_y);
	...
	addi	$bp,$ap_real,0
	addi	$rp,$sp,$U2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(U2, in1_x, Hsqr);
	...
	addi	$bp,$ap_real,32
	addi	$rp,$sp,$S2
	bl	__GFp_nistz256_mul_mont	# p256_mul_mont(S2, in1_y, Hcub);
...
$code.=<<___;
########################################################################
# void GFp_nistz256_ord_mul_mont(uint64_t res[4], uint64_t a[4],
#                                uint64_t b[4]);
...
################################################################################
# void GFp_nistz256_ord_sqr_mont(uint64_t res[4], uint64_t a[4],
#                                uint64_t rep);
...
$code.=<<___;
########################################################################
# void	GFp_nistz256_scatter_w5(void *out, const P256_POINT *inp,
#				int index);
.globl	GFp_nistz256_scatter_w5
.align	4
GFp_nistz256_scatter_w5:
	slwi	$index,$index,2
	add	$out,$out,$index
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	GFp_nistz256_scatter_w5,.-GFp_nistz256_scatter_w5

########################################################################
# void	GFp_nistz256_gather_w5(P256_POINT *out, const void *inp,
#				int index);
.globl	GFp_nistz256_gather_w5
.align	4
GFp_nistz256_gather_w5:
	neg	r0,$index
	sradi	r0,r0,63
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	GFp_nistz256_gather_w5,.-GFp_nistz256_gather_w5

########################################################################
# void	GFp_nistz256_scatter_w7(void *out, const P256_POINT_AFFINE *inp,
#				int index);
.globl	GFp_nistz256_scatter_w7
.align	4
GFp_nistz256_scatter_w7:
	li	r0,8
	mtctr	r0
	add	$out,$out,$index
	subi	$inp,$inp,8
...
.Loop_scatter_w7:
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	GFp_nistz256_scatter_w7,.-GFp_nistz256_scatter_w7

########################################################################
# void	GFp_nistz256_gather_w7(P256_POINT_AFFINE *out, const void *inp,
#				int index);
.globl	GFp_nistz256_gather_w7
.align	4
GFp_nistz256_gather_w7:
	li	r0,8
	mtctr	r0
	neg	r0,$index
	sradi	r0,r0,63
...
.Loop_gather_w7:
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	GFp_nistz256_gather_w7,.-GFp_nistz256_gather_w7
___
}
